...
- (NSString*)readItLaterKey {
	return @"76cBcp6bT4436E4diWA1e13a1agdk26c";
}
...
- (NSString*)twitterConsumerKey {
	return @"KeonIPYODNMeHt1xXbXYlw";
}

- (NSString*)twitterSecret {
	return @"2EhDS0mfNY41nBhDgMXWKjJmfWCoP5SuJjhOjRdam60";
}
